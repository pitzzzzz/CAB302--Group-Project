...
public class JobDetailController {
    ...
    public void setBackdropNode(Node node) {
        ...
        if (this.backdropNode != null) {
            // stronger blur so the semi-transparent grey overlay appears soft and the pathway content
            // behind the popup is clearly de-emphasized (frosted look)
            this.backdropNode.setEffect(new GaussianBlur(14));
        }
    }
