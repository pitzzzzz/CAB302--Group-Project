module com.javaninjas.careerpathway {
    ...
    // export core models so they can be referenced across the module
    exports com.javaninjas.careerpathway.core.models;
    ...
    // export the actual quizResults models package used throughout the app
    exports com.javaninjas.careerpathway.pages.quizResults.models;

    opens com.javaninjas.careerpathway.pages.quizResults.models to javafx.fxml;
